...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        initObjectPicking, isObjectAmongObjects, bindListener, getMaterialEditableTextures,
        replaceMaterialEditableTexture, getSceneAnimFrameRate, getSceneByAction,
    };
};
...
registerOnClick('Metal_1', false, false, [0,1,2], false, function(event) {
    assignMat('Stand', 'Chrome', undefined);
}, function(event) {});
registerOnClick('Metal_2', false, false, [0,1,2], false, function(event) {
    assignMat('Stand', 'gold', undefined);
}, function(event) {});
registerOnClick('Metal_3', false, false, [0,1,2], false, function(event) {
    assignMat('Stand', 'black', undefined);
}, function(event) {});

registerOnClick('Slab1', false, false, [0,1,2], false, function(event) {
    replaceTexture('woodmaterial0', 'wood', 'wood_basecolor_1.jpg', false, function() {});
}, function(event) {});
registerOnClick('Slab2', false, false, [0,1,2], false, function(event) {
    replaceTexture('woodmaterial0', 'wood', 'wood_basecolor_2.jpg', false, function() {});
}, function(event) {});
registerOnClick('Slab3', false, false, [0,1,2], false, function(event) {
    replaceTexture('woodmaterial0', 'wood', 'wood_basecolor_3.jpg', false, function() {});
}, function(event) {});
